    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item d-md-none">
                <a class="nav-link active" aria-current="page" href="#recording">
...
<div class="container mt-2">
    <div class="row">
        <div class="col-md">
            ...
            <ol>
                <li> We have several words or phrases that we'd like you to say. Under each phrase, press the
                    <b>Record</b> button and say the word or phrase. Accept any pop-ups that ask you to use your
                    computer/phone's microphone.
                    ...
                    when recording is actually happening.
                </li>
                <li>
        ...
        <div class="col-md">
            <h3><a id="recording">Recording</a></h3>
